    ...
    <section id="main">
        <aside id="s-user-alerts" class="sidebar">
            <ul class="tab-nav tn-justified tn-icon m-t-10" data-tab-color="teal">
                ...
                <li><a class="sua-notifications" href="#sua-notifications" data-toggle="tab"><i class="zmdi zmdi-notifications"></i>skdgfuysdfy</a></li>
        ...
        <aside id="s-main-menu" class="sidebar">
            ...
            <ul class="smm-alerts">
                ...
                <li>
                    <a style="text-decoration: none; color: white;" href="#modal-pesan" data-toggle="modal"><i class="zmdi zmdi-parking"></i></a>
                </li>
            </ul>
                        ...
                        <form id="form-pesan">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="fg-line">
                                        <input type="text" name="tanggal_pesan" id="tanggal_pesan" class="form-control" value="<?php echo date('d M, Y') ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="fg-line">
                                        <textarea rows="5" name="isi_pesan" id="isi_pesan" class="form-control" placeholder="Masukkan pesan anda jangan ngawur"></textarea>
                                    </div>
                                </div>

                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-link">Kirim</button>
            ...
            <ul class="main-menu">
                ...
                if($_SESSION["level"]==3){
                    ?>
                    <li><a href="dashboard.php?pages=tabungan"><i class="zmdi zmdi-format-underlined"></i> Tabungan</a></li>
                    <?php
                }

                if($_SESSION["level"]==1){
                    ?>
                    <li class="sub-menu <?php if($_GET['pages']=='anggota' || $_GET['pages']=='pegawai'){echo 'active';} ?>">
                        <a href="#" data-ma-action="submenu-toggle"><i class="zmdi zmdi-view-list"></i> Managemen User</a>

                        <ul>
                            <li class="<?php if($_GET['pages']=='anggota'){echo 'active';} ?>"><a href="dashboard.php?pages=anggota"">Anggota</a></li>
                            <li class="<?php if($_GET['pages']=='pegawai'){echo 'active';} ?>"><a href="dashboard.php?pages=pegawai"">Pegawai</a></li>
                        </ul>
                    </li>
                    <?php
                }
        ...
        <section id="content">
            <?php 
            if(isset($_GET["pages"])){
                if($_GET["pages"]=="tabungan"){
                    include '../pages/tabungan.php';
                }
                else if($_GET["pages"]=="anggota"){
                    include '../pages/user/anggota.php';
                }
                else if($_GET["pages"]=="pegawai"){
                    include '../pages/user/pegawai.php';
                }
            }else{
                include 'home.php';
            }
