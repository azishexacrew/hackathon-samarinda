...
import hackathon.user.c_trash.masyarakat.peta_masyarakat;
...
public class peta_petugas extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String url = "http://192.168.43.216/ctrash/markers.php";
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        cameraPosition = new CameraPosition.Builder().target(here).zoom(10).build();
    ...
    private void addMarker(LatLng latlng, final String title, final String desk) {
        ...
        gMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                Intent intent = new Intent(peta_petugas.this, menu_verifikasi.class);
                intent.putExtra("name", marker.getTitle().toString());
                intent.putExtra("status", marker.getSnippet().toString());
    ...
    private void getMarkers() {
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(peta_petugas.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
