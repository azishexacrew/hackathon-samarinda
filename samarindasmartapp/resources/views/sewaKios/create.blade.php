		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<strong><a href="{{ route('pengguna.rukokios') }}"><i class="fa fa-chevron-left" style="color: blue;"></i></a> Sewa Kios Baru</strong>
				</div>
				<div style="margin-left: 10px;margin-right: 10px; ">
					{!! Form::open(array('route' => 'sewaKios.store', 'files' => true)) !!}
						...
						<br>
						{{ Form::label('kios_id', 'No. Kios Yg Ingin Disewa:') }}
							<select name="kios_id" class="form-control">
								@foreach($sewaKios as $data)
								<option value='{{ $data->id }}'>{{ $data->nomor_kios }}</option>
								@endforeach
							</select>
							<br>
