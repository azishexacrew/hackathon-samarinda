...
public class CycleIndicatorSlideImageHome extends LinearLayout {
    ...
    public CycleIndicatorSlideImageHome(Context context) {
        super(context);
        init(context, null);
    }

    public CycleIndicatorSlideImageHome(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CycleIndicatorSlideImageHome(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CycleIndicatorSlideImageHome(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
