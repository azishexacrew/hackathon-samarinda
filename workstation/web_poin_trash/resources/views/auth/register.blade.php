...
<head>
    ...
    <title>Poin Trash | Registration Page</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Poin </b>Trash</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('tanggal_lahir') ? ' has-error' : '' }}">
                <input type="date" name="foto" class="form-control" placeholder="Date of birth">
            ...
            <div class="form-group has-feedback{{ $errors->has('kontak') ? ' has-error' : '' }}">
                <input type="text" name="kontak" class="form-control" placeholder="Number Phone">
                <span class="glyphicon glyphicon-location form-control-feedback"></span>
            ...
            <div class="form-group has-feedback{{ $errors->has('alamat') ? ' has-error' : '' }}">
                <input type="text" name="alamat" class="form-control" placeholder="Addres">
                <span class="glyphicon glyphicon-location form-control-feedback"></span>
